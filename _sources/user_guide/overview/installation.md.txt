...
3. Install **pytorch** (>=2.0.0) following the [official instructions](https://pytorch.org/get-started/locally/).
...
- Build LuisaRender and its python binding:
    ```
    cd ./ext/LuisaRender
    cmake -S . -B build -D CMAKE_BUILD_TYPE=Release -D PYTHON_VERSIONS=3.9 -D LUISA_COMPUTE_DOWNLOAD_NVCOMP=ON -D LUISA_COMPUTE_DOWNLOAD_OIDN=ON -D LUISA_COMPUTE_ENABLE_GUI=OFF
